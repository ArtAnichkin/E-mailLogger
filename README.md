...
Частый просмотр e-mail ящика утомителен когда на него приходят письма обширных назначений и адресов. Такую проблему призван решить данный скрипт, который по-рассписанию скидывает список адресов последних непрочитанных сообщений в ВК.
